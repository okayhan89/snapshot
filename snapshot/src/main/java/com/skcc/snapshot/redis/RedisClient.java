package com.skcc.snapshot.redis;
...
/*	@Autowired
	private JedisConnectionFactory jedisMGConnectionFactory;
*/
/*	public String getMainMgRedisIp() {
		return jedisMGConnectionFactory.getHostName();
	}*/

/*	public void changeActiveRedisMG(String requestIP) {
        jedisMGConnectionFactory.setHostName(requestIP);
		redisMgTemplate.setConnectionFactory(jedisMGConnectionFactory);
	}*/
...
/*    public Set<String> hkeysFromMG(String key) {
...
/*    public Map<String, Object> hgetAllFromMG(String key) {
	...
	public Object hget(String key, String field) {
		...
		Object obj = null;
		try {
//			Span span = this.tracer.createSpan("redis");
...
/*    public Object hgetFromMG(String key, String field) {
    	return redisMgTemplate.<String, Object>opsForHash().get(key, field);
    }*/
...
/*    public Object getFromMG(String key) {
